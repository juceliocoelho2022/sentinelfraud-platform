...
class FraudDecisionServiceTest {
    ...
    @BeforeEach void setup() {
        ...
        service=new FraudDecisionService(List.of(new HighAmountRule(new BigDecimal("10000")),new ForeignTransactionRule()),repository,kafka,new SimpleMeterRegistry());
    }
    @Test void shouldBlockCombinedRisk() {
        ...
        verify(kafka).send(eq("fraud.assessment.completed.v1"),eq("tx-99"),any());
    }
}
